...
run_fuzz ./pkg/transport FuzzParsePathRequestWire "$(fuzz_time_for transport 10s)"
...
run_fuzz ./pkg/link FuzzSelectRequestedPartIndexes "$(fuzz_time_for link 10s)"
run_fuzz ./pkg/link FuzzSplitResourceMetadata "$(fuzz_time_for link 10s)"
...
run_fuzz ./pkg/resource FuzzPrepareOutboundForLinkLayout "$(fuzz_time_for resource 15s)"
run_fuzz ./pkg/cryptography FuzzRemovePKCS7Padding "$(fuzz_time_for cryptography 10s)"
run_fuzz ./pkg/pageserver FuzzParseNodeStatusAppData "$(fuzz_time_for pageserver 10s)"
...
run_fuzz ./pkg/buffer FuzzHandleMessageEOF "$(fuzz_time_for buffer 10s)"
run_fuzz ./pkg/channel FuzzHandleInboundEnvelope "$(fuzz_time_for channel 10s)"
