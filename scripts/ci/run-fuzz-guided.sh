...
run_fuzz ./pkg/transport FuzzParsePathRequestWireOracle "$(fuzz_time_for transport 10s)"
...
run_fuzz ./pkg/link FuzzSelectRequestedPartIndexesOracle "$(fuzz_time_for link 10s)"
run_fuzz ./pkg/link FuzzSplitResourceMetadataOracle "$(fuzz_time_for link 10s)"
...
run_fuzz ./pkg/resource FuzzPrepareOutboundForLinkLayoutOracle "$(fuzz_time_for resource 15s)"
run_fuzz ./pkg/cryptography FuzzRemovePKCS7PaddingOracle "$(fuzz_time_for cryptography 10s)"
run_fuzz ./pkg/pageserver FuzzParseNodeStatusAppDataOracle "$(fuzz_time_for pageserver 10s)"
...
run_fuzz ./pkg/buffer FuzzHandleMessageEOFOracle "$(fuzz_time_for buffer 10s)"
run_fuzz ./pkg/channel FuzzHandleInboundEnvelopeOracle "$(fuzz_time_for channel 10s)"
