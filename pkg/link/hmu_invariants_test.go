...
func TestChooseHashmapUpdateSegmentInvariants(t *testing.T) {
	const sdu = 384
...
// FuzzSelectRequestedPartIndexes builds a small outbound resource and
// checks selected indexes stay inside the collision-guard window.
func FuzzSelectRequestedPartIndexes(f *testing.F) {
