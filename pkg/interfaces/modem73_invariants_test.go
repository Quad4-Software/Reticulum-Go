...
func TestModem73MTUInvariants(t *testing.T) {
	floor := 500
...
func TestModem73BitrateInvariants(t *testing.T) {
	cfg := map[string]any{
...
func TestModem73ShortFrame(t *testing.T) {
	cfg := map[string]any{
...
func TestModem73PathTimeout(t *testing.T) {
